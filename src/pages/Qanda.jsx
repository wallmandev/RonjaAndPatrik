        ...
        <div className="accordion-inner" ref={accordionRef}>
            ...
            <div className="accordion-dresscode">
                ...
                <div className="accordion-item">
                    <button
                    className="accordion-header"
                    onClick={() => toggleAccordion(6)} // Använd index 0 för den första frågan
                    >
                ...
                <div className="accordion-item">
                    <button
                    className="accordion-header"
                    onClick={() => toggleAccordion(7)} // Använd index 1 för den andra frågan
                    >
            ...
            <div className="accordion-foodanddrink">
                ...
                <div className="accordion-item">
                    <button
                    className="accordion-header"
                    onClick={() => toggleAccordion(8)} // Använd index 0 för den första frågan
                    >
                ...
                <div className="accordion-item">
                    <button
                    className="accordion-header"
                    onClick={() => toggleAccordion(9)} // Använd index 1 för den andra frågan
                    >
            ...
            <div className="accordion-guestinfo">
                ...
                <div className="accordion-item">
                    <button
                    className="accordion-header"
                    onClick={() => toggleAccordion(10)} // Använd index 0 för den första frågan
                    >
                    How do I RSVP?
                    </button>
                ...
                <div className="accordion-item">
                    <button
                    className="accordion-header"
                    onClick={() => toggleAccordion(11)} // Använd index 1 för den andra frågan
                    >
                    Can I bring a guest?
                    </button>
            ...
            <div className="accordion-gifts">
                ...
                <div className="accordion-item">
                    <button
                    className="accordion-header"
                    onClick={() => toggleAccordion(13)} // Använd index 0 för den första frågan
                    >
                ...
                <div className="accordion-item">
                    <button
                    className="accordion-header"
                    onClick={() => toggleAccordion(14)} // Använd index 1 för den andra frågan
                    >
            ...
            <div className="accordion-request">
                ...
                <div className="accordion-item">
                    <button
                    className="accordion-header"
                    onClick={() => toggleAccordion(15)} // Använd index 0 för den första frågan
                    >
                ...
                <div className="accordion-item">
                    <button
                    className="accordion-header"
                    onClick={() => toggleAccordion(16)} // Använd index 1 för den andra frågan
                    >
            ...
            <div className="accordion-photography">
                ...
                <div className="accordion-item">
                    <button
                    className="accordion-header"
                    onClick={() => toggleAccordion(18)} // Använd index 0 för den första frågan
                    >
